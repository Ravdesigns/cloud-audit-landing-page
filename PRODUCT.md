...
- The real-engagement figures now sit as one compressed line beneath those four: *2,140 resources read across 3 subscriptions, 15 to 287 findings, $14,820 recovered monthly,* still carrying "shared under NDA" and the in-component caveat that this was a full ZopNight engagement and **not** the free 24-hour audit. That caveat is load-bearing: without it the figures read as a 24-hour outcome. Keeping this line was a deliberate choice when the band was rebuilt, because it is the only proof on the page that is about cost auditing specifically. No 24-hour figure appears among the four, so nothing in the band attaches the free-audit promise to a four-week engagement.
